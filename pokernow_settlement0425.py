...
def href(name):
    ...
    return '<a href="https://account.venmo.com/u/' + name[1:] + '">' + name + '</a>'


def get_venmo_profile_link(username):
    '''Gets a hyperlink to a Venmo profile. Username starts with @'''
    return '<a href="https://account.venmo.com/u/' + username[1:] + '">' + username + '</a>'
...
def get_venmo_amount_only_link(username, amount, description=None):
    ...
    return f'<a href="https://account.venmo.com/?txn=charge&audience=private&recipients={username[1:]}&amount={quot}.{rem:02}{note}">' + get_printable_dollar_amount(amount) + '<a>'
...
def get_venmo_amount_and_username_link(username, amount, description=None):
    ...
    return f'{printable_amount} <a href="https://account.venmo.com/?txn=charge&audience=private&recipients={username[1:]}&amount={quot}.{rem:02}{note}">{username}<a>'
